...
ActiveRecord::Schema.define(version: 2021_05_15_130200) do
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["ratingable_type", "ratingable_id"], name: "index_ratings_on_ratingable_type_and_ratingable_id", unique: true
  end
